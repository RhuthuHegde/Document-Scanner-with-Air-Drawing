...
scanner_utils.initializeTrackbars()
count = 0
...
while True:
    ...
    thres = scanner_utils.valTrackbars()  # GET TRACK BAR VALUES FOR THRESHOLDS
    ...
    biggest, maxArea = scanner_utils.biggestContour(contours)  # FIND THE BIGGEST CONTOUR
    if biggest.size != 0:
    ...
    stackedImage = scanner_utils.stackImages(imageArray, 0.75, lables)
